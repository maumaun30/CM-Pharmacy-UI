        ...
        <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-6">
          ...
          >
            {[
              {
                label: "Total Revenue",
                value: `₱${summaryStats.totalRevenue.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
                icon: <DollarSign className="h-6 w-6 text-white" />,
                color: "from-emerald-500 to-green-600",
              },
              {
                label: "Total Discounts",
                value: `₱${summaryStats.total_discount.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
              ...
              },
              {
                ...
                value: `₱${summaryStats.avgTransaction.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
              ...
              <Card
                key={stat.label}
                className="p-5 bg-white border-2 border-emerald-100 hover:border-emerald-300 hover:shadow-lg transition-all"
              >
                ...
                >
                  ...
                  <div className="space-y-6 mt-4">
                    ...
                    <div className="space-y-3">
                      ...
                      {selectedSale.cash_amount && (
                        <>
                          <div className="flex justify-between items-center text-gray-600">
                            <span>Cash Received</span>
                            <span className="font-semibold">
                              ₱{selectedSale.cash_amount.toFixed(2)}
                            </span>
                          </div>
                          {selectedSale.change_amount != null && (
                            <div className="flex justify-between items-center text-gray-600">
                              <span>Change</span>
                              <span className="font-semibold">
                  ...
                  <div className="space-y-5 mt-4">
                    ...
                    <div className="flex gap-3 pt-2">
                      ...
                      <Button
                        ...
                        disabled={refundItemCount === 0 || refundLoading}
                  ...
                  <div className="space-y-4 mt-4">
                    {refundHistoryLoading ? (
                      ...
                      refundHistory.map((refund) => (
                        <div
                          key={refund.id}
                          className="border-2 border-amber-100 rounded-xl overflow-hidden"
                        >
