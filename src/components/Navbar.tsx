            ...
            <div className="hidden xl:flex items-center gap-3">
              ...
              <div className="pl-3 border-l-2 border-emerald-200">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent side="top" align="end" className="mb-2 w-48 border-emerald-200">
                    <DropdownMenuLabel className="text-emerald-700">
                      <div className="flex flex-col">
                        <span className="font-bold">{getFullName(user) || user.username}</span>
                    ...
                    <DropdownMenuItem asChild>
                      <Link href="/account" className="cursor-pointer flex items-center">
                        <User className="w-4 h-4 mr-2 text-emerald-600" />Account
                      </Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild>
                    ...
                    <DropdownMenuSeparator />
                    <DropdownMenuItem className="text-red-600 cursor-pointer font-medium" onClick={logout}>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      ...
                      size="sm"
                    >
                      <Menu className="w-4 h-4 mr-2 text-emerald-600" />Menu
                    </Button>
                  </DropdownMenuTrigger>
                  <DropdownMenuContent
                    side="top"
                  ...
                  >
                    <DropdownMenuLabel className="py-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="font-bold text-gray-800 truncate">{getFullName(user) || user.username}</p>
                    ...
                    {canInventory && (
                      <>
                        ...
                        <DropdownMenuItem asChild>
                          <Link href="/stock" className="cursor-pointer flex items-center py-2">
                            <Package className="w-4 h-4 mr-3 text-emerald-600" />Stock List
                          </Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem asChild>
                          <Link href="/stock/add" className="cursor-pointer flex items-center py-2">
                            <Package className="w-4 h-4 mr-3 text-emerald-600" />Add Stock
                          </Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem asChild>
                          <Link href="/stock/adjust" className="cursor-pointer flex items-center py-2">
                            <ChartNoAxesCombined className="w-4 h-4 mr-3 text-emerald-600" />Adjust Stock
                          </Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem asChild>
                          <Link href="/stock/transactions" className="cursor-pointer flex items-center py-2">
                    ...
                    <DropdownMenuSeparator />
                    <DropdownMenuLabel className="text-xs font-bold text-emerald-700 uppercase tracking-wide">Account</DropdownMenuLabel>
                    <DropdownMenuItem asChild>
                      <Link href="/account" className="cursor-pointer flex items-center py-2">
                        <User className="w-4 h-4 mr-3 text-emerald-600" />My Account
                      </Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild>
                      <Link href="/settings" className="cursor-pointer flex items-center py-2">
                        <Settings className="w-4 h-4 mr-3 text-emerald-600" />Settings
                      </Link>
                    </DropdownMenuItem>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem className="text-red-600 cursor-pointer font-semibold py-2" onClick={logout}>
            ...
            <div className="flex md:hidden items-center gap-2">
              ...
              <DropdownMenu>
                ...
                >
                  ...
                  <DropdownMenuLabel className="text-xs font-bold text-emerald-700 uppercase tracking-wide">Quick Actions</DropdownMenuLabel>
                  <DropdownMenuItem asChild>
                    <Link href="/sales" className="cursor-pointer flex items-center py-2">
                      <TrendingUp className="w-4 h-4 mr-3 text-emerald-600" />Sales
                    </Link>
